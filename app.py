...
<div class="modal" id="kickModal">
    <div class="modal-content">
        <h2>Kick</h2>
        <input type="text" id="kickReason" placeholder="Raison (optionnel)">
...
<div class="modal" id="playSoundModal">
    <div class="modal-content">
        ...
        <div class="modal-buttons">
            <button class="modal-btn cancel">Annuler</button>
            <button class="modal-btn confirm" id="confirmSound">Jouer</button>
        </div>
    </div>
</div>
...
<div class="modal" id="textScreenModal">
    <div class="modal-content">
        <h2>Text Screen</h2>
        <input type="text" id="screenText" placeholder="Texte à afficher" value="test">
        <div class="modal-buttons">
            <button class="modal-btn cancel">Annuler</button>
            <button class="modal-btn confirm" id="confirmText">Afficher</button>
        </div>
    </div>
</div>
...
<div class="modal" id="luaExecModal">
    <div class="modal-content">
        ...
        <div class="modal-buttons">
            <button class="modal-btn cancel">Annuler</button>
            <button class="modal-btn confirm" id="confirmLua">Exécuter</button>
        </div>
    </div>
</div>
...
<div class="modal" id="importFileModal">
    <div class="modal-content">
        <h2>Importer Fichier</h2>
        <input type="file" id="luaFileInput" accept=".lua,.txt">
        <div class="modal-buttons">
            <button class="modal-btn cancel">Annuler</button>
            <button class="modal-btn confirm" id="confirmImport">Exécuter</button>
        </div>
    </div>
</div>
...
<div class="modal" id="executePayloadModal">
    <div class="modal-content">
...
<div class="modal" id="execAllModal">
    <div class="modal-content">
        ...
        <textarea id="execAllScript" placeholder="Code Lua à exécuter sur tous les clients connectés..." style="height:320px;"></textarea>
        <div class="modal-buttons">
            <button class="modal-btn cancel">Annuler</button>
