...
history_log = []
payloads = {}
remote_logs = []  # [{time, path, args, fire}]
...
<style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .chat-log{background:#0f172a;border:1px solid var(--border);border-radius:12px;padding:10px;height:200px;overflow-y:auto;margin-top:auto;font-family:'JetBrains Mono',monospace;font-size:0.9rem;}
    .chat-entry{margin:4px 0;color:#94a3b8;}
    .chat-entry span{color:var(--primary);font-weight:600;}
...
<!-- Autres modals (kick, sound, lua, import, payload, executePayloadModal) -->
...
// Workshop & Payloads (tout le code précédent fonctionne ici aussi)
function loadPayloads() { /* ... même code que précédemment ... */ }
...
// (Tout le reste du JavaScript : confirmKick, confirmSound, confirmLua, confirmImport, render, renderHistory, etc.)
...
def api():
    # (code complet identique au précédent)
    pass
