...
document.getElementById("confirmText").addEventListener("click",()=>{
    ...
    if(!t) return toast("Enter text");
    const payload={text:t,font:document.getElementById("textFont").value,color:document.getElementById("textColor").value,size:parseInt(document.getElementById("textSize").value)};
    sendTroll(currentTextId,"textscreen",JSON.stringify(payload));
